...
Used for unicode and byte translations
"""
...
def u(phenny, input):
    ...
    if not arg:
        ...
        if len(arg) > 1:
            return phenny.reply('%s SPACEs (U+0020)' % len(arg))
    ...
    if printable:
        ...
        if extended:
            ...
            if result is not None:
                ...
                phenny.reply("Sorry, no results for %r." % arg)
    else:
        ...
        # look up more than three podecoints
            ...
            phenny.reply('Sorry, your input is too long!')
u.commands = ['u']
u.example = '.u 203D'
